...
class AtomDC:
    ...
    def __post_init__(self):
        ...
        # Position
        # self.r = np.array([Fraction(x) for x in self.r], dtype=Fraction)
        self.r = np.array(self.r, dtype=float)
    ...
    def __lt__(self, other) -> bool:
        '''Implement comparison of atoms for sorting.
        Assumes no atoms can be in the same position.'''

        return tuple(self.r) < tuple(other.r)
