...
class Canvas(app.Canvas):
    def __init__(self):
        ...
        for i, arrow_type in enumerate(arrow_types):
            arrows = [
                visuals.ArrowVisual(line1, color='g', width=4, method='agg',
                                    arrows=arrows1, arrow_type=arrow_type,
                                    arrow_size=30.0),
                visuals.ArrowVisual(line2, color='w', width=6, method='agg',
                                    arrows=arrows2, arrow_type=arrow_type,
                                    arrow_size=35.0),
                visuals.ArrowVisual(line3, color='w', width=8, method='gl',
